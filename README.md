...
>
> For embeddings I use `nomic-embed-text` via Ollama (`EMBEDDING_MODEL=nomic-embed-text`) — no external API calls needed and it works well for both English and mixed-language documents.
